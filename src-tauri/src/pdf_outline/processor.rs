...
impl PdfOutlineProcessor {
    ...
    fn parse_chain<E: OutlineEngine>(
        engine: &E,
        start_id: &str,
        offset: i32,
        level: i32,
    ...
    pub fn set_outline<E: OutlineEngine>(
        engine: &mut E,
        root: Bookmark,
        offset: i32,
        scale: ViewScaleType,
        ...
        let (first, last, count) =
            Self::build_level(engine, &root.children, &outlines_id, offset, scale)?;
    ...
    fn build_level<E: OutlineEngine>(
        ...
        for item in bookmarks {
            ...
            let (child_first, child_last, child_count) =
                Self::build_level(engine, &item.children, &current_id, offset, scale)?;
