<script lang="ts">
    import { generateRulePreview, type PageLabel } from '@/lib/types/page-label.ts';
    ...
    let { rule, labelWidth = '100px' }: Props = $props();

    let previewText = $derived(generateRulePreview(rule));
</script>
